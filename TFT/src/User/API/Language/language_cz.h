...
#define _LANGUAGE_CZ_H_
    ...
    #define CZ_ABL_COMPLETE           "Bed Leveling Complete"
    #define CZ_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define CZ_ABL_START              "Start"
    #define CZ_CONFIRMATION           "Are you sure?"
    #define CZ_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define CZ_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define CZ_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define CZ_ABL_SETTINGS_UBL_LOAD  "Load from slot"
