...
#define _LANGUAGE_DU_H_
    ...
    #define DU_ABL                    "ABL"
    #define DU_ABL_COMPLETE           "Bed Leveling Complete"
    #define DU_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define DU_ABL_START              "Start"
    #define DU_CONFIRMATION           "Are you sure?"
    #define DU_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define DU_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define DU_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define DU_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define DU_ABL_SLOT0              "Slot 0"
    #define DU_ABL_SLOT1              "Slot 1"
    #define DU_ABL_SLOT2              "Slot 2"
    #define DU_ABL_SLOT3              "Slot 3"
    #define DU_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    #define DU_ABL_Z                  "Z Fade"
    #define DU_ABL_ENABLE             "ABL: on"
    #define DU_ABL_DISABLE            "ABL: off"
