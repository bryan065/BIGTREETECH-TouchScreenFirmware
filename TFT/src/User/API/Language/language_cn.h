...
#define _LANGUAGE_CN_H_
    ...
    #define CN_ABL                    "自动调平"
    #define CN_ABL_COMPLETE           "Bed Leveling Complete"
    #define CN_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define CN_ABL_START              "Start"
    ...
    #define CN_ABL_ENABLE             "ABL: on"
    #define CN_ABL_DISABLE            "ABL: off"
    ...
    #define CN_SETTING_SAVE           "Save settings"
