...
#define _LANGUAGE_HU_H_
    ...
    #define HU_ABL                    "ABL"
    #define HU_ABL_COMPLETE           "Bed Leveling Complete"
    #define HU_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define HU_ABL_START              "Start"
    #define HU_CONFIRMATION           "Are you sure?"
    #define HU_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define HU_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define HU_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define HU_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define HU_ABL_SLOT0              "Slot 0"
    #define HU_ABL_SLOT1              "Slot 1"
    #define HU_ABL_SLOT2              "Slot 2"
    #define HU_ABL_SLOT3              "Slot 3"
    #define HU_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    #define HU_ABL_Z                  "Z Fade"
    #define HU_ABL_ENABLE             "ABL: on"
    #define HU_ABL_DISABLE            "ABL: off"
    ...
    #define HU_RETRACT_AUTO           "Auto FW Retract"
