...
#define _LANGUAGE_FR_H_
    ...
    #define FR_ABL                    "ABL"
    #define FR_ABL_COMPLETE           "Bed Leveling Complete"
    #define FR_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define FR_ABL_START              "Start"
    #define FR_CONFIRMATION           "Are you sure?"
    #define FR_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define FR_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define FR_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define FR_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define FR_ABL_SLOT0              "Slot 0"
    #define FR_ABL_SLOT1              "Slot 1"
    #define FR_ABL_SLOT2              "Slot 2"
    #define FR_ABL_SLOT3              "Slot 3"
    #define FR_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    ...
    #define FR_PLR_EN                 "Power loss recovery"
    ...
    #define FR_RETRACT_AUTO           "Auto FW Retract"
