...
#define _LANGUAGE_RU_H_
    ...
    #define RU_ABL                    "ABL"
    #define RU_ABL_COMPLETE           "Bed Leveling Complete"
    #define RU_ABL_SMART_FILL         "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define RU_ABL_START              "Start"
    #define RU_CONFIRMATION           "Are you sure?"
    #define RU_ABL_SETTINGS           "Bilinear Bed Leveling"
    #define RU_ABL_SETTINGS_UBL       "Unified Bed Leveling"
    #define RU_ABL_SETTINGS_UBL_SAVE  "Save to slot"
    #define RU_ABL_SETTINGS_UBL_LOAD  "Load from slot"
    #define RU_ABL_SLOT0              "Slot 0"
    #define RU_ABL_SLOT1              "Slot 1"
    #define RU_ABL_SLOT2              "Slot 2"
    #define RU_ABL_SLOT3              "Slot 3"
    #define RU_ABL_SLOT_EEPROM        "Remember slot for next\nreboot? (Save EEPROM)"
    #define RU_ABL_Z                  "Z Fade"
    #define RU_ABL_ENABLE             "ABL: on"
    #define RU_ABL_DISABLE            "ABL: off"
    ...
    #define RU_EEPROM_RESTORE_INFO    "Загрузить настройки из EEPROM?"
